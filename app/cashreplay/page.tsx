...
export default function CashReplayPage() {
  ...
  useEffect(() => {
    if (videoContainerRef.current && !hasLoadedVideo.current) {
      ...
      videoContainerRef.current.innerHTML = `<wistia-player media-id="${WISTIA_MEDIA_ID}" aspect="${WISTIA_ASPECT}"></wistia-player>`;
    }
  }, []);
    ...
    <>
      ...
      <div className="replay-page">
        ...
        <div className="sticky-bar">
          <span className="sticky-text">Want Brian&apos;s team to build your content-to-cash game plan? &rarr;</span>
        ...
        <section className="hero">
          ...
          <div className="hero-content">
            <h1>How to Turn Your Instagram Content Into an Extra <span className="blue">$10K+/Month</span></h1>
            <p className="sub">Watch the exact <strong>Instagram Marketing Funnel</strong> behind 700K+ followers, 30M+ monthly views, and $50M+ in sales — and how to use it to turn followers into booked, qualified sales calls.</p>
          </div>
        </section>
          ...
          <div className="video-cal-grid">
            ...
            <div className="cal-col">
              <div className="cal-cta-header">
                ...
                <h3 className="cal-headline">Ready to turn your content into cash?</h3>
                <p className="cal-sub">Pick a time below. Brian&apos;s team will audit your content, show you where the leaks are, and map out your exact Instagram Marketing Funnel — no pressure, no pitch-fest.</p>
                <ul className="cal-bullets">
                  <li>Custom content plan for your offer</li>
                  <li>Identify the #1 thing leaking clients</li>
                  <li>Map your path to an extra $10K+/month</li>
                </ul>
              </div>
        ...
        <div className="proof-strip reveal">
          <div className="proof-item">
            <div className="proof-number">700K+</div>
            <div className="proof-label">Followers</div>
          </div>
          <div className="proof-item">
            <div className="proof-number">30M+</div>
            <div className="proof-label">Monthly Views</div>
          </div>
          <div className="proof-item">
            <div className="proof-number">$50M+</div>
            <div className="proof-label">In Sales</div>
          </div>
          <div className="proof-item">
            <div className="proof-number">12,000+</div>
            <div className="proof-label">Business Owners Trained</div>
          </div>
        </div>
        ...
        <section className="section reveal">
          ...
          <h2>Watching Doesn&apos;t Sign Clients.<br />Implementing Does.</h2>
          <p className="body-text">You just watched the funnel. Now here&apos;s the truth nobody likes to say out loud:</p>
          <p className="body-text">Watching a masterclass doesn&apos;t sign clients. <strong>Implementing does.</strong> And if you&apos;re like most of the business owners we&apos;ve worked with, you&apos;re going to hit the same wall everyone hits — you know what to post, but you&apos;re not sure how to dial it in for your avatar, your voice, and your offer.</p>
          <p className="body-text">That&apos;s what this call is for.</p>
          <p className="body-text">In 30 minutes, one of Brian&apos;s senior coaches will:</p>

          <ul className="check-list">
            <li>Pinpoint the #1 thing leaking clients out of your funnel right now</li>
            <li>Build you a custom content plan for the next 30 days</li>
            <li>Show you exactly how to turn views into DMs, and DMs into booked sales calls</li>
          </ul>

          <p className="body-text" style={{ marginTop: '28px' }}>If we&apos;re a fit to work together, we&apos;ll tell you. If we&apos;re not, you&apos;ll walk away with a plan you can run yourself. Either way, you win.</p>
        ...
        <section className="section results-section reveal">
          <div style={{ maxWidth: '780px', margin: '0 auto' }}>
            ...
            <h2>Real Business Owners.<br />Real Revenue. Real Timelines.</h2>
            <p className="body-text">Every one of these transformations happened by installing the same content systems you just watched in the replay.</p>

            <div className="results-grid">
              <div className="result-card">
                <div className="result-name">@kaycapitals</div>
                <div className="result-before-after">
                  <span className="result-val before">$80K/mo</span>
                  <span className="result-arrow">→</span>
                  <span className="result-val after">$2M/mo</span>
                </div>
                <div className="result-timeline">In 2 Years</div>
              </div>
              <div className="result-card">
                <div className="result-name">@realtordrdotcom</div>
                <div className="result-before-after">
                  <span className="result-val before">$24M</span>
                  <span className="result-arrow">→</span>
                  <span className="result-val after">$50M+</span>
                </div>
                <div className="result-timeline">2024 → 2025</div>
              </div>
              <div className="result-card">
                <div className="result-name">@ryanthewindowcleaner</div>
                <div className="result-before-after">
                  <span className="result-val before">$25K</span>
                  <span className="result-arrow">→</span>
                  <span className="result-val after">$100K</span>
                </div>
                <div className="result-timeline">First $100K Month — 9,450 Followers</div>
              </div>
              <div className="result-card">
        ...
        <div className="cta-block reveal">
          ...
          <p>Book a free strategy call with our team. We&apos;ll audit where you&apos;re stuck and map out your content-to-cash game plan.</p>
        ...
        <section className="section reveal">
          ...
          <ul className="check-list">
            <li>You&apos;re a business owner who wants to add an extra $10K+/month using Instagram content</li>
            <li>You&apos;ve been posting but aren&apos;t converting views into clients consistently</li>
            <li>You want qualified sales calls booked every week without living in the DMs</li>
            <li>You know content is the leverage — you just need someone to build the funnel for your offer and avatar</li>
            <li>You want a proven framework, not another course that collects dust</li>
          ...
          <ul className="check-list x-list">
            <li>You don&apos;t have an offer or a business yet</li>
            <li>You&apos;re looking for a magic button with zero effort required</li>
            <li>You&apos;re not willing to show up consistently for your audience</li>
        ...
        <section className="section reveal" style={{ paddingTop: 0 }}>
          <div className="guarantee-box">
            ...
            <p>If Brian and his team don&apos;t help you beat your highest-ever revenue month, you get a full refund of every dollar you paid — plus $1,000 sent to you for wasting your time. He assumes all the risk so you don&apos;t have to.</p>
          </div>
        </section>
        ...
        <section className="section reveal">
          ...
          <div className="faq-item">
            ...
            <div className="faq-a">Totally fair. Here&apos;s what the call is not: a high-pressure sales pitch or a generic &quot;let me tell you about our program&quot; spiel. Here&apos;s what it is: a working session. You bring your current numbers, your content, and your biggest bottleneck. We bring the system behind 700K+ followers and $50M+ in sales, plus a refund guarantee on the back end of any program we&apos;d recommend. Worst case, you get a free audit from someone who&apos;s done this at scale.</div>
          </div>
          <div className="faq-item">
            <div className="faq-q" onClick={toggleFAQ}>What happens on the strategy call?</div>
            <div className="faq-a">It&apos;s a free, no-obligation 30-minute call with a member of Brian&apos;s team. They&apos;ll audit where you&apos;re stuck, build you a custom content plan, and show you how to start booking qualified sales calls every week. If it&apos;s a fit to work together, they&apos;ll walk you through what that looks like — no pressure either way.</div>
          </div>
          <div className="faq-item">
            <div className="faq-q" onClick={toggleFAQ}>Do I need a big following for this to work?</div>
            <div className="faq-a">No. The funnel is built to convert the audience you already have. One of Brian&apos;s clients hit his first $100,000 month with 9,450 followers. Reach is nice; conversion is what pays.</div>
          </div>
          <div className="faq-item">
            <div className="faq-q" onClick={toggleFAQ}>I&apos;m not a fitness coach — does this work for me?</div>
            <div className="faq-a">Yes. The Instagram Marketing Funnel has been run by business owners in real estate, home services, finance, health, and more. Book a call and we&apos;ll tell you honestly whether it&apos;s the right fit for your business.</div>
          </div>
          <div className="faq-item">
        ...
        {/* Final CTA */}
        <div className="cta-block reveal">
          <h2>You&apos;ve Seen The Funnel.<br />Now Let&apos;s Build Yours.</h2>
          <p>The Instagram Marketing Funnel works. The only question is whether you&apos;re going to keep guessing — or let someone who&apos;s built it to 700K followers and $50M+ in sales map out exactly what to do next.</p>
