...
export const metadata: Metadata = {
  ...
  description:
    'Free live training for business owners: the 3-part Conversation Engine Brian Mark uses to turn everyday Instagram content into booked sales calls — no funnels, email lists, ads or tech.',
  openGraph: {
    title: 'Free Live Training — Turn Instagram Into High-Ticket Clients | Brian Mark',
    description:
