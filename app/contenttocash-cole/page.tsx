...
// Duplicate of /contenttocash for Cole's traffic. Same form, same
// /api/submit-contenttocash endpoint and Supabase table — registrations are told
// apart by page_path ("/contenttocash-cole"), which is read from the URL at submit.
...
export default function ContentToCashColePage() {
  useFbTrack("PageView");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    router.push(form.invest === "yes" ? "/contenttocash-cole/confirmation" : "/contenttocash-cole/confirmation-b");
  };
