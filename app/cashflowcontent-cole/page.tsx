...
// Duplicate of /cashflowcontent for Cole's traffic. Still the paid-traffic
// Typeform, so applications land in the same place and redirect to
// /cashflowcontent/received. Swap in a Cole-specific Typeform (and point its
// redirect at a matching received page) to split them, the way
// /cashflowcontent-organic does.
...
export default function CashFlowContentColePage() {
  useFbTrack("PageView");
