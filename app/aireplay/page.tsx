    ...
    <>
      ...
      <div className="replay-page">
        ...
        <div className="sticky-bar">
          <span className="sticky-text">Want Brian&apos;s team to build your $100K game plan? &rarr;</span>
        ...
        <section className="hero">
          ...
          <div className="hero-content">
            <h1>How Coaches Are Using <span className="blue">AI</span> to Add <span className="blue">$1,000–$2,000/Week</span> to Their Business</h1>
            <p className="sub">Watch the exact AI + personal brand system <strong>12,000+ coaches</strong> are using to sign 2–4 new clients every single week — without chasing views or burning out.</p>
          </div>
        </section>
          ...
          <div className="video-cal-grid">
            ...
            <div className="cal-col">
              <div className="cal-cta-header">
                ...
                <h3 className="cal-headline">Ready to build your $100K game plan?</h3>
                <p className="cal-sub">Pick a time below. Brian&apos;s team will audit where you&apos;re stuck and map out your exact AI + personal brand system — no pressure, no pitch-fest.</p>
                <ul className="cal-bullets">
                  <li>Custom AI content plan for your offer</li>
                  <li>Identify the #1 thing leaking clients</li>
                  <li>Map your path to $1–2K/week added</li>
                </ul>
              </div>
        ...
        <div className="proof-strip reveal">
          ...
          <div className="proof-item">
            <div className="proof-number">$1–2K</div>
            <div className="proof-label">Added Per Week</div>
          </div>
        </div>
        ...
        <section className="section reveal">
          ...
          <p className="body-text">You just watched the blueprint. Now here&apos;s the truth nobody likes to say out loud:</p>
          <p className="body-text">Watching a masterclass doesn&apos;t sign clients. <strong>Implementing does.</strong> And if you&apos;re like most of the 12,000+ coaches we&apos;ve worked with, you&apos;re going to hit the same wall everyone hits — you know what to do, but you&apos;re not sure how to dial it in for your avatar, your voice, and your offer.</p>
          ...
          <ul className="check-list">
            ...
            <li>Build you a custom AI + content plan for the next 30 days</li>
            <li>Show you exactly how to book 4–6 sales calls a week without chasing views</li>
          </ul>
        ...
        <section className="section results-section reveal">
          <div style={{ maxWidth: '780px', margin: '0 auto' }}>
            ...
            <p className="body-text">Every one of these transformations happened by installing the same AI + content systems you just watched in the replay.</p>
        ...
        <div className="cta-block reveal">
          ...
          <p>Book a free strategy call with our team. We&apos;ll audit where you&apos;re stuck and map out your AI + personal brand game plan.</p>
        ...
        <section className="section reveal">
          ...
          <ul className="check-list">
            <li>You&apos;re an online coach who wants to add $1,000–$2,000/week using AI and content</li>
            <li>You&apos;ve been posting but aren&apos;t converting views into clients consistently</li>
            <li>You want 4–6 sales calls booked per week without grinding in the DMs</li>
            <li>You know AI is the edge — you just need someone to build the system for your offer and avatar</li>
        ...
        <section className="section reveal">
          ...
          <div className="faq-item">
            ...
            <div className="faq-a">Totally fair. Here&apos;s what the call is not: a high-pressure sales pitch or a generic &quot;let me tell you about our program&quot; spiel. Here&apos;s what it is: a working session. You bring your current numbers, your content, and your biggest bottleneck. We bring 8 years of scaling coaches from zero to six figures and a refund guarantee on the back end of any program we&apos;d recommend. Worst case, you get a free audit from someone who&apos;s done this 12,000 times.</div>
          </div>
          <div className="faq-item">
            <div className="faq-q" onClick={toggleFAQ}>What happens on the strategy call?</div>
            <div className="faq-a">It&apos;s a free, no-obligation 30-minute call with a member of Brian&apos;s team. They&apos;ll audit where you&apos;re stuck, build you a custom AI + content plan, and show you how to start booking 4–6 sales calls per week. If it&apos;s a fit to work together, they&apos;ll walk you through what that looks like — no pressure either way.</div>
          </div>
          <div className="faq-item">
            <div className="faq-q" onClick={toggleFAQ}>How is the AI system different from what I&apos;m already doing?</div>
            <div className="faq-a">Most coaches use AI to write captions. Brian&apos;s system uses AI to build an entire content engine — hooks, scripts, repurposing flows, DM sequences — all calibrated to your avatar and your offer. The output isn&apos;t generic content. It&apos;s content that sounds like you and converts.</div>
          </div>
          <div className="faq-item">
            <div className="faq-q" onClick={toggleFAQ}>I&apos;m not a fitness coach — does this work for me?</div>
            <div className="faq-a">The system is built for online coaches in the health and fitness space, but the AI + personal brand framework has worked across nutrition, golf, peak performance, and detox coaching. Book a call and we&apos;ll tell you honestly whether it&apos;s the right fit.</div>
          </div>
          <div className="faq-item">
        ...
        {/* Final CTA */}
        <div className="cta-block reveal">
          <h2>You&apos;ve Seen The Blueprint.<br />Now Let&apos;s Build Yours.</h2>
          <p>The AI + personal brand system works. 12,000+ coaches have proven it. The only question is whether you&apos;re going to keep guessing — or let someone who&apos;s done this 12,000 times map out exactly what to do next.</p>
